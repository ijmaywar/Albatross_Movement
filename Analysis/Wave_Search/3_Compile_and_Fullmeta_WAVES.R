...
if (min_peak_prob == 0) {
  read_dir <- paste0(GD_dir, "Analysis/Maywar/Wave_Search/Flaps_Hourly/Flaps_HMM_GLS_ECG/p_0/")
  write_dir <- paste0(GD_dir, "Analysis/Maywar/Wave_Search/Flaps_Hourly/Flaps_HMM_GLS_ECG_Compiled/p_0/")
...
write.csv(compiled_m, file=paste0(write_dir,"Compiled_Flaps_HMM_GLS_ECG_Hourly_WAVES.csv"), row.names=FALSE)
...
write.csv(compiled_ECG_m, file=paste0(write_dir,"ECGonly_Compiled_Flaps_HMM_GLS_ECG_Hourly_WAVES.csv"), row.names=FALSE)
