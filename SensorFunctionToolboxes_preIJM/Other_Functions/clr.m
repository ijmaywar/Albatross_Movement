...
243, 188, 000, 'cadmium_yellow';
248, 192, 000, 'traffic_yellow';
183, 144, 073, 'ochre_yellow';
162, 132, 170, 'curry_yellow';
255, 162, 000, 'melon_yellow';
224, 167, 000, 'broom_yellow';
246, 156, 000, 'dahlia_yellow';
237, 160, 078, 'pastel_yellow';
221, 113, 000, 'yellow_orange';
...
106, 018, 030, 'purple_red';
087, 027, 036, 'wine_red';
063, 034, 036, 'black_red';
106, 049, 045, 'oxide_red';
122, 028, 031, 'brown_red';
198, 132, 109, 'beige_red';
153, 041, 035, 'tomato_red';
...
192, 053, 115, 'magenta';
045, 074, 110, 'blue_violet'; 
004, 070, 098, 'green_blue';
022, 050, 121, 'ultramarine_blue';
020, 049, 084, 'sapphire_blue';
028, 032, 042, 'black_blue';
000, 071, 133, 'signal_blue';
055, 098, 137, 'brillant_blue'; 
044, 057, 067, 'grey_blue';
023, 088, 116, 'azure_blue';
000, 069, 121, 'gentian_blue';
018, 039, 058, 'steel_blue';
017, 128, 180, 'light_blue';
029, 048, 083, 'cobalt_blue';
099, 120, 147, 'pigeon_blue';
000, 115, 175, 'sky_blue';
000, 081, 140, 'traffic_blue';
000, 137, 140, 'turquoise_blue';
000, 086, 130, 'capri_blue';
000, 062, 072, 'ocean_blue';
000, 116, 120, 'water_blue';
034, 040, 086, 'night_blue';
069, 101, 139, 'universe_blue';
096, 144, 170, 'pastel_blue';
