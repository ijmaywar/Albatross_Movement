addpath(genpath("/Users/melindaconners/Dropbox/Academia/04 SUNY/Conners_ToBeCompleted/bird island/BIISL_2019_Shared_Folder/tag documentation and software/Neurologger- updated 10-29/InstallationCD_Evolocus/NeurologgerWithAdditionalSensors(MARG, Altimeter, Thermometer)/"))
    %/Users/melindaconners/Dropbox/Academia/04 SUNY/MIAT_2019/MIAT_Albatross_Rproj/MIAT_albatross/00 codes/03 accelerometer analyses/Matlab/functions

% Set current directory to where data lives
CurrentPath ="/Users/melindaconners/Dropbox/Academia/04 SUNY/Conners_ToBeCompleted/bird island/BIISL_2019_Shared_Folder/tag documentation and software/Neurologger- updated 10-29/InstallationCD_Evolocus/NeurologgerWithAdditionalSensors(MARG, Altimeter, Thermometer)/";
% CurrentPath ="/Users/melindaconners/Dropbox/Academia/04 SUNY/00 Project Components/3-Bird Island/BIRD ISL 2019-20/Data/Neurologger/"
cd(CurrentPath) %cd is a function that sets the current directory. Inside the parentheses is the string that contains the directory.
...
%% Quick Plott (load tagtools functions)
