...
m_model %>% filter(flaps<12,wind_vel<3.283906,GLS_state=='dry',id=='GHAL_20211118_UJ55')

# Dynamic soaring for specific ID
m_model %>% filter(flaps<12,wind_vel>11.6236,GLS_state=='dry',id=='GHAL_20211118_UJ55')
